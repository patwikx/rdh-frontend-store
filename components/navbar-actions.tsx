      ...
      <Sheet open={isSheetOpen} onOpenChange={handleSheetOpenChange}>
        <SheetTrigger asChild>
          <Button 
            ...
            variant="outline" 
            size="icon" 
            className="relative rounded-full hover:bg-primary hover:text-primary-foreground transition-colors duration-200" 
                      ...
                      <Card className="overflow-hidden">
                        <CardContent className="p-4 flex items-center space-x-4">
                          ...
                          <Button 
                            ...
                            className="text-destructive hover:text-destructive-foreground hover:bg-destructive transition-colors duration-200"
                          >
